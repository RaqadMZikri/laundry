<?php
    ...
    $profil = $_SESSION['user'];
        ...
        // Mengambil data
        $item_pesanan = mysqli_query($conn, "SELECT * FROM item_pesanan");
        $layanan = mysqli_query($conn, "SELECT * FROM layanan");
        $pelanggan = mysqli_query($conn, "SELECT * FROM pelanggan");
        $pesanan = mysqli_query($conn, "SELECT * FROM pesanan");
    
        // Menghitung data
        $jumlah_item_pesanan = mysqli_num_rows($item_pesanan);
        $jumlah_layanan = mysqli_num_rows($layanan);
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            Item Pesanan</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$jumlah_item_pesanan;?></div>
                                        </div>
                                        <div class="col-auto">
                                        <i class="fas fa-fw fa-shopping-bag fa-2x text-black-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <i class="fas fa-hand-holding fa-2x text-black-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?=$jumlah_pelanggan;?></div>
                                                </div>
                            ...
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-cart-plus fa-2x text-black-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
